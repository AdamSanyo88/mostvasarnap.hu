...
<br/><h5><strong>2018-as egyéni eredmények</strong></h5><br/><img src="images/vk_charts/egyeni_pe2.png" style="height: 100%; width: 100%; object-fit: contain"><br/><table class="striped">
              <thead>
                <tr>
                    <th>Jelöltek</th>
...
<br/>
<h5><strong>2018. április 8-i becslések (átszavazással):</strong></h5><br/><img src="images/vk_charts/pe2.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
...
<h5><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">dr. Szél Bernadett (LMP)</span><span id="esely2"></span><span></span></strong></h5>
<h5><strong><a href="https://rendszervaltas2018.hu">Márki-Zay Péter ajánlása</a>: dr. Szél Bernadett (LMP) </strong></h5>
<h5><strong><a href="https://www.v18.eu/53korzet">A V18 ajánlása</a>: dr. Szél Bernadett (LMP)</strong></h5>
...
<td>Betlehem Csaba - MKKP <img src="images/mkkp_logo.png" style="width:49px;height:30px;"></td>
 <td id="id_mkkp">2.0% &emsp; <span id="id_mkkp2">(1.7%)</span></td>
            ...
            </table><h5>Várható győztes: <span id="gyoztes">Szél Bernadett (LMP)</span><span id="esely"></span><span></span></h5>
