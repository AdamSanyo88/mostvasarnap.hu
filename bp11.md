...
<br/>
<h5><strong>2018. április 8-i becslések (átszavazással):</strong></h5><br/><img src="images/vk_charts/bp11.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
...
<h5><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">Varju László (DK)</span><span id="esely2"></span><span></span></strong></h5>
<h5><strong><a href="https://rendszervaltas2018.hu">Márki-Zay Péter ajánlása</a>: Varju László (DK) </strong></h5>
<h5><strong><a href="https://www.v18.eu/53korzet">A V18 ajánlása</a>: Varju László (DK)</strong></h5>
...
<br/><br/><table class="striped">
             ...
             <tr>
                  <td>dr. Zsigmond Barna Pál - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="id_fidesz">32.0% &emsp; <span id="id_fidesz2">(32.6%)</span></td>
			</tr>
			<tr><td>Hegedűs Loránt Gézáné - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> <td id="id_jobbik">12.0% &emsp; <span id="id_jobbik2">(9.2%)</span></td></tr>
<tr>
                  <td>Varju László - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="id_baloldal">32.6% &emsp; <span id="id_baloldal2">(42.6%)</span></td>
			</tr>
			<tr>
                  <td>Kanász-Nagy Máté - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="id_lmp">12.0% &emsp; <span id="id_lmp2">(7.9%)</span></td>
			</tr>
			<tr>
				  <td>Molnár Tibor - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				   <td id="id_momentum">5.2% &emsp; <span id="id_momentum2">(3.4%)</span></td>
			</tr>
<tr>                
<td>Paizs Miklós - MKKP <img src="images/mkkp_logo.png" style="width:49px;height:30px;"></td>
 <td id="id_mkkp">2.4% &emsp; <span id="id_mkkp2">(1.9%)</span></td>
</tr>  
              </tbody>
            </table><h5>Várható győztes: <span id="gyoztes">Varju László (DK)</span><span id="esely"></span><span></span></h5>
